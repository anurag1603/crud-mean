...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        this.postService.getPosts().subscribe(v => {
            console.log('i really hope this works --------------->', v);
        });
    }
};
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [_service_post_service__WEBPACK_IMPORTED_MODULE_5__["PostService"]],
...
module.exports = __webpack_require__(/*! D:\meanApps\post-app\src\main.ts */"./src/main.ts");
